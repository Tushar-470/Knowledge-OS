...
> *Your self-contained, from-scratch roadmap — no mentor required*
...
*These give you the complete conceptual framework*

---

#### 📄 Paper 1 — THE CORNERSTONE REVIEW ⭐⭐⭐⭐⭐
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/29468973/
...
**URL:** https://ijsar.in (search title)
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/42002057/
...
*Focus on the sub-domain closest to your research question*

---

#### 📄 Paper 6 — CYCLODEXTRIN DOCKING GOLD STANDARD ⭐⭐⭐⭐⭐
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/30218981/
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/33066657/
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/35872021/
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/32801637/
...
**URL:** https://doi.org/10.3390/molecules26010182 🔓 (Open Access)
...
#### 📄 Paper 11 — DRUG-POLYMER MISCIBILITY TRAP ⭐⭐⭐⭐
...
**URL:** https://pubs.acs.org/doi/10.1021/acs.molpharmaceut.4c00810
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/40517970/
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/41717430/
...
*Software, algorithms, and quantitative methods*
...
**URL:** https://pubs.acs.org (search title)
...
#### 📄 Paper 16 — EXCIPIENT SELECTION MD SIMULATION ⭐⭐⭐⭐
...
**URL:** https://pubs.acs.org/doi/abs/10.1021/acs.molpharmaceut
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/41599218/
...
*Case studies matching specific formulation types*

---

#### 📄 Paper 19 — LIPID NANOPARTICLE FORMULATION DOCKING ⭐⭐⭐⭐
...
**URL:** https://www.ovid.com (search Ovid or ScienceDirect)
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/33802960/
...
#### 📄 Paper 23 — HYDROQUINONE CYCLODEXTRIN CREAM ⭐⭐⭐
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/41034678/
...
#### 📄 Paper 24 — MONOCLONAL ANTIBODY EXCIPIENT INCOMPATIBILITY ⭐⭐⭐⭐
**Title:** Mechanism of Low Molecular Weight Impurity Formation in an IgG1 Monoclonal Antibody Formulation

**PMID:** 39826838

**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/39826838/
...
**PubMed URL:** https://pubmed.ncbi.nlm.nih.gov/40870995/
...
|---|---|---|
| **AutoDock Vina** | Main docking engine | https://vina.scripps.edu/ |
| **AutoDock 4.2** | Classic docking, more control | https://autodock.scripps.edu/ |
| **PyRx** | GUI wrapper for AutoDock Vina | https://pyrx.sourceforge.io/ |
| **BIOVIA Discovery Studio Visualizer** | Visualize docking results | https://www.3ds.com/free download |
| **PyMOL** (free version) | 3D structure visualization | https://pymol.org/ |
| **Avogadro** | Draw/edit ligand structures | https://avogadro.cc/ |
| **Open Babel** | Convert file formats | http://openbabel.org/ |
| **GROMACS / AMBER** | Molecular dynamics simulation | free academic |
| **SwissADME** | Calculate drug properties | http://www.swissadme.ch/ |
...
|---|---|---|
| **PubChem** | Get drug 3D structures (SDF files) | https://pubchem.ncbi.nlm.nih.gov/ |
| **RCSB PDB** | Protein structures | https://www.rcsb.org/ |
| **Cambridge Structural Database** | Small molecule crystal structures | https://www.ccdc.cam.ac.uk/ |
| **DrugBank** | Drug properties and targets | https://go.drugbank.com/ |
| **ChemDraw / ChemSpider** | Draw molecules, get SMILES | https://www.chemspider.com/ |
...
> - PubMed (https://pubmed.ncbi.nlm.nih.gov) — All PMID-cited papers
...
>
> *Always check individual paper licenses before redistribution. Access restricted papers via your university library, Unpaywall browser extension, or contact corresponding authors directly for preprints.*
